...
import { resolveArcRpc, GATEWAY_FACILITATOR, ARC_EXPLORER, GATEWAY_WALLET_ARC } from "@butler/arc";

/** Arc 101 payment trace — adapted from the-canteen-dev/circle-agent */
const RPC = resolveArcRpc();
const GATEWAY_API = process.env.GATEWAY_API ?? GATEWAY_FACILITATOR;
